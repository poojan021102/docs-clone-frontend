...
export const ALL_DOCUMENTS_URI: string =
  BACKEND_DOCUMENT_URI + "/getAllDocuments";
export const DELETE_DOCUMENT_URI: string = BACKEND_DOCUMENT_URI + "/delete";
export const GET_DOCUMENT_CONTENT: string =
  BACKEND_DOCUMENT_URI + "/getContent";
export const GET_ALL_SHARED_EMAIL: string =
  BACKEND_DOCUMENT_URI + "/allSharedUserEmail";
...
export const SHARED_DOCUMENT_URL: string =
  BACKEND_DOCUMENT_URI + "/sharedDocuments";
