...
export default function ShowEditor({
  ...
  useEffect(() => {
    ...
    socket.on("disconnectingClientToServer", handleDisconnectingServerToClient);
    ...
    return () => {
      ...
      // socket.off("disconnect", handleDisconnectingServerToClient);
      socket.on(
        "disconnectingClientToServer",
